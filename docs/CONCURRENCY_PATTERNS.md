...
> - [CONCURRENCY_SAFETY.md](./CONCURRENCY_SAFETY.md) - Comprehensive concurrency safety guide including failure modes, debugging, and testing
> - [SYSTEM_DESIGN.md](./SYSTEM_DESIGN.md) - Overall system architecture
> - [HOOKS_SYSTEM_DESIGN.md](./HOOKS_SYSTEM_DESIGN.md) - File locking for session capture
...
This document describes the code-level patterns and pitfalls. For higher-level concurrency design, failure modes, and debugging guidance, see [CONCURRENCY_SAFETY.md](./CONCURRENCY_SAFETY.md).
